"""
Django settings for studenttrack project.
...
SECRET_KEY = 'django-insecure-^@l_^mup77@+m!@4qjgh-u&%s5i-s@(7)&@*bvtlzzyybz16&x'
...
ROOT_URLCONF = 'studenttrack.urls'
...
WSGI_APPLICATION = 'studenttrack.wsgi.application'
